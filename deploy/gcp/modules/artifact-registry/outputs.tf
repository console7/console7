...
output "repository_url" {
  description = "The pushable/pullable base path of the repository, \"<region>-docker.pkg.dev/<project>/<repository_id>\". Append \"/<image>@sha256:...\" to form the digest-pinned reference providers/cloud-gcp Config.SandboxImage consumes (it rejects a tag-only reference — B3)."
